...
CORS_ALLOWED_ORIGINS = [
    url.strip()
    for url in os.getenv("CORS_ALLOWED_ORIGINS", "http://127.0.0.1:5500,http://localhost:5500").split(",")
    if url.strip()
]

CSRF_TRUSTED_ORIGINS = [
    url.strip()
    for url in os.getenv("CSRF_TRUSTED_ORIGINS", "http://127.0.0.1:5500,http://localhost:5500").split(",")
    if url.strip()
]
